...
export function createGame(){
 ...
 ],log:[{role:'narrator',turn:0,text:"雨把墓口外的石地淋得发亮。你独自带着一套简单工具来到这里，想做一次谨慎的古墓探查：看清门后的陈设，记下自己的发现，然后平安离开。眼下没有必须赶在谁之前拿走的宝物，也没有同伴在前面替你试路。你能依靠的，是灯光、手边的材料和愿意多看一眼的耐心。\n\n这段探查从一道已经打开的石门前开始。你仍站在门外，门槛就在脚边；方形石镇稳稳压住两根铁栓，头顶的悬锤被机关扣着。你已经弄清这处危险：挪走石镇会释放悬锤，门槛附近就是它的落点。只要支撑没有改变，眼前的门就保持敞开，你不必为了查看门内而先碰动它。\n\n举起灯，门内约两步远的石地落在光里，再往里才是伪王墓。石门敞开，因此你可以留在外面观察，也可以把东西投向门内近处；隔着更深的阴影，却不能凭空知道整间墓室的情况。身后有雨水滴落，门边的石墙摸上去潮冷。\n\n手里是一盏罩着玻璃的普通油灯，灯罩能打开，火焰有热量。你还带着干厚布、约五步长的探路绳、空青铜杯、一小截白垩和手记。它们的用途由你的做法决定，不必等一个固定按钮来允许：可以先举灯辨认落脚处，用杯子接些雨水，或想个办法在门外试探门内。这里没有按输入次数减少的灯油期限，但点燃、投出或损坏物品会留下真实后果。你准备先做什么？"}]};
