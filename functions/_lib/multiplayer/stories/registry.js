...
export function storyFor(state){
 ...
 const story={'cooperative-v1':v1,'cooperative-v2':v2,'cooperative-v3':v3}[revision];
 if(!story||(state?.storyId&&state.storyId!==story.id)||(revision==='cooperative-v3'&&state.storyRevision!==v3.revision))throw new ApiError(503,'此存档的剧本版本暂不可用，进度保留。','story_version_unavailable');
 return story;
}
