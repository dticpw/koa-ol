export const toneOf = type => ['shield', 'shield2', 'seelieCute'].includes(type) ? 'defense'
  : ['add1', 'add2', 'desire', 'slam', 'perfect', 'perfect2', 'seelieInsight'].includes(type) ? 'attack' : 'utility';
...
export function opponentEffect(card) {
  return ({
    ...
    joy: '双方各获得 1 张普通王牌。', cycle: '对手随机弃掉另外 2 张王牌，再获得 3 张。',
    ...
    slam: '对手移除自己的全部护盾；你败北时，多受 3 点伤害。',
    ...
    perfect: '你败北时，多受 3 点伤害；对手抽取不会爆牌的最大可用数牌。',
    perfect2: '你败北时，多受 5 点伤害；对手抽取不会爆牌的最大可用数牌。',
